...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Tässä ohjeet : Sinulla on aluksi 5 euroa, voitat lisää rahaa pelin aikana, jos saat onnenseiskan ja voit pelata niin pitkään, kun rahasi riittää. ");
